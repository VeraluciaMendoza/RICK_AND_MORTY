...
describe('Test de RUTAS', () => {
  ...
  describe("GET /rickandmorty/login", () => {
    it('Retorna un objeto con la propiedad access en true si se reciben credenciales correctas', async () => {
    ...
    it('Retorna un objeto con la propiedad access en false si se reciben credenciales incorrectas', async () => {
